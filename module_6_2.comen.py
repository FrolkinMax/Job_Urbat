...
# - Имеет
# атрибуты
# `owner`, `__model`, `__engine_power`, `__color`.
# - Метод
# `set_color`
# проверяет, можно
# ли
...
# допустимыми
# в
# `__COLOR_VARIANTS`, игнорируя регистр.
# - Методы `get_model`, `get_horsepower`, и `get_color`
# возвращают соответствующую информацию.
# - Метод `print_info` выводит все атрибуты объекта.
#
# 2. ** Класс
# Sedan **:
# - Наследуется
